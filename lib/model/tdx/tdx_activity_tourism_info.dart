import 'tdx_point_type.dart';
import 'tdx_tourism_picture.dart';

class TdxActivityTourismInfo {
  ...
  final TdxTourismPicture? picture; // 活動照片
  final TdxPointType? position; // 活動位置
  ...
  factory TdxActivityTourismInfo.fromJson(Map<String, dynamic> json) {
    return TdxActivityTourismInfo(
      id: json['ActivityID'],
      ...
      picture: TdxTourismPicture.fromJson(json['Picture']),
      position: TdxPointType.fromJson(json['Position']),
      class1: json['Class1'],
      class2: json['Class2'],
      mapUrl: json['MapUrl'],
